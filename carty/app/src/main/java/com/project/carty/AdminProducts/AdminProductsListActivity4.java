...
public class AdminProductsListActivity4 extends AppCompatActivity implements AdminProductsAdapter.onItemClickListener {
    ...
    private String category_name="Cheese and Dairy";
    private String fprice;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_products_list4);
        ...
        mAdapter = new AdminProductsAdapter(AdminProductsListActivity4.this, mUploads,mDatabaseRef);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(AdminProductsListActivity4.this);
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Cheese and Dairy");
        mDBListener= mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(AdminProductsListActivity4.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
                sale_all.setVisibility(View.INVISIBLE);
            }
        });
        ...
        sale_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder builder= new AlertDialog.Builder(AdminProductsListActivity4.this);
                builder.setTitle("Enter the Sale Percentage You Want to Apply for All Products:");
                final EditText saleAll=new EditText(AdminProductsListActivity4.this);
                ...
                builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (TextUtils.isEmpty(sale_percentage_all)) {
                            ...
                            Toast.makeText(AdminProductsListActivity4.this, "All Category Products are Added Successfully to Sales", Toast.LENGTH_LONG).show();
    ...
    public void onDeleteClick(final int position) {
        ...
        Toast.makeText(AdminProductsListActivity4.this, "Removed Successfully From Cheese and Dairy Category", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onEditPriceClick(final int position) {
        ...
        final EditText price=new EditText(AdminProductsListActivity4.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(edited_price)) {
                    ...
                    Toast.makeText(AdminProductsListActivity4.this, "This Product Price Edited Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onEditNameClick(final int position) {
        ...
        final EditText name=new EditText(AdminProductsListActivity4.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(edited_name)) {
                    ...
                    Toast.makeText(AdminProductsListActivity4.this, "This Product Name Edited Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onMakeSaleClick(final int position) {
        ...
        final EditText sale=new EditText(AdminProductsListActivity4.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(sale_percentage)) {
                    ...
                    Toast.makeText(AdminProductsListActivity4.this, "Added Successfully to Sales", Toast.LENGTH_SHORT).show();
