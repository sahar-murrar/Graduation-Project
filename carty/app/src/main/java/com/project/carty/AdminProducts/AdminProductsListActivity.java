...
import com.project.carty.activities.CreditCardActivity;
...
public class AdminProductsListActivity extends AppCompatActivity implements AdminProductsAdapter.onItemClickListener {
    ...
    private String category_name="Fruits and Vegetables";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(AdminProductsListActivity.this);
        ...
        mDBListener= mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(AdminProductsListActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
                sale_all.setVisibility(View.INVISIBLE);
            }
        });
                ...
                sale_all.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final AlertDialog.Builder builder= new AlertDialog.Builder(AdminProductsListActivity.this);
                        builder.setTitle("Enter the Sale Percentage You Want to Apply for All Products:");
                        final EditText saleAll=new EditText(AdminProductsListActivity.this);
                        ...
                        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (TextUtils.isEmpty(sale_percentage_all)) {
                                    ...
                                    Toast.makeText(AdminProductsListActivity.this, "All Category Products are Added Successfully to Sales", Toast.LENGTH_LONG).show();
    ...
    public void onDeleteClick(final int position) {
        ...
        Toast.makeText(AdminProductsListActivity.this, "Removed Successfully From Fruits and Vegetables Category", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onEditPriceClick(final int position) {
        ...
        final EditText price=new EditText(AdminProductsListActivity.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(edited_price)) {
                    ...
                    Toast.makeText(AdminProductsListActivity.this, "This Product Price Edited Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onEditNameClick(final int position) {
        ...
        final EditText name=new EditText(AdminProductsListActivity.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(edited_name)) {
                    ...
                    Toast.makeText(AdminProductsListActivity.this, "This Product Name Edited Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onMakeSaleClick(final int position) {
        ...
        final EditText sale=new EditText(AdminProductsListActivity.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(sale_percentage)) {
                    ...
                    Toast.makeText(AdminProductsListActivity.this, "Added Successfully to Sales", Toast.LENGTH_SHORT).show();
