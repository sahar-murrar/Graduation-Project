...
public class AdminProductsListActivity7 extends AppCompatActivity implements AdminProductsAdapter.onItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_products_list7);
        ...
        mAdapter = new AdminProductsAdapter(AdminProductsListActivity7.this, mUploads,mDatabaseRef);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(AdminProductsListActivity7.this);
        ...
        mDBListener= mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(AdminProductsListActivity7.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
                sale_all.setVisibility(View.INVISIBLE);
            }
        });
        ...
        sale_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder builder= new AlertDialog.Builder(AdminProductsListActivity7.this);
                builder.setTitle("Enter the Sale Percentage You Want to Apply for All Products:");
                final EditText saleAll=new EditText(AdminProductsListActivity7.this);
                ...
                builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (TextUtils.isEmpty(sale_percentage_all)) {
                            ...
                            Toast.makeText(AdminProductsListActivity7.this, "All Category Products are Added Successfully to Sales", Toast.LENGTH_LONG).show();
    ...
    public void onDeleteClick(final int position) {
        ...
        Toast.makeText(AdminProductsListActivity7.this, "Removed Successfully From Rice, Pasta and Legumes Category", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onEditPriceClick(final int position) {
        ...
        final EditText price=new EditText(AdminProductsListActivity7.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(edited_price)) {
                    ...
                    Toast.makeText(AdminProductsListActivity7.this, "This Product Price Edited Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onEditNameClick(final int position) {
        ...
        final EditText name=new EditText(AdminProductsListActivity7.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(edited_name)) {
                    ...
                    Toast.makeText(AdminProductsListActivity7.this, "This Product Name Edited Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onMakeSaleClick(final int position) {
        ...
        final EditText sale=new EditText(AdminProductsListActivity7.this);
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (TextUtils.isEmpty(sale_percentage)) {
                    ...
                    Toast.makeText(AdminProductsListActivity7.this, "Added Successfully to Sales", Toast.LENGTH_SHORT).show();
