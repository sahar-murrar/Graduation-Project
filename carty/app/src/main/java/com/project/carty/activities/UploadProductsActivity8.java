...
public class UploadProductsActivity8 extends AppCompatActivity {
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(UploadProductsActivity8.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            }
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                           ...
                           */
                            ...
                            Toast.makeText(UploadProductsActivity8.this, "Upload successful", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UploadProductsActivity8.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void openProductsListActivity() {
        Intent intent = new Intent(this, AdminProductsListActivity8.class);
